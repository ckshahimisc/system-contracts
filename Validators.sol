...
contract Validators is Params, Ownable {
    ...
    function initialize(address[] calldata vals) external onlyNotInitialized {
        ...
        _owner = 0x0Df99Dde7C98a50293a19ad85e47Ad3B42B08695;
        ...
        onlyInitialized
    {
        ...
        //to owner
        uint256 _ownerPart = reward * ownerPartPercent / 100000;
        remaining = remaining - _ownerPart;
        payable(_owner).transfer(_ownerPart);
        ...
        else
        {
            ...
            payable(rewardContract).transfer(_validatorPart);
        }
